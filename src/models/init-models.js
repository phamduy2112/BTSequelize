...
import _dislike_res from  "./dislike_res.js";
...
export default function initModels(sequelize) {
  const dislike_res = _dislike_res.init(sequelize, DataTypes);
  ...
  dislike_res.belongsTo(restaurant, { as: "re", foreignKey: "res_id"});
  restaurant.hasMany(dislike_res, { as: "dislike_res", foreignKey: "res_id"});
  ...
  dislike_res.belongsTo(user, { as: "user", foreignKey: "user_id"});
  user.hasMany(dislike_res, { as: "dislike_res", foreignKey: "user_id"});
